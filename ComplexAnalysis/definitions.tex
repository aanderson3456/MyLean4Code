...
\begin{lstlisting}[language=Caml]
def HasFDerivAt_R2_eps (u v : $\mathbb{R} \times \mathbb{R} \to \mathbb{R}$) (ux₀ uy₀ vx₀ vy₀ : $\mathbb{R}$) (a : $\mathbb{R} \times \mathbb{R}$) : Prop :=
  LimitR2toR2 (fun h => (
...
def DifferentiableAt_R2_eps (u v : $\mathbb{R} \times \mathbb{R} \to \mathbb{R}$) (a : $\mathbb{R} \times \mathbb{R}$) : Prop := 
  $\exists$ ux₀ uy₀ vx₀ vy₀ : $\mathbb{R}$, HasFDerivAt_R2_eps u v ux₀ uy₀ vx₀ vy₀ a
\end{lstlisting}
...
\begin{lstlisting}[language=Caml]
def HasDerivAt_RtoR2_eps (f : $\mathbb{R} \to \mathbb{R} \times \mathbb{R}$) (f'₀ : $\mathbb{R} \times \mathbb{R}$) (t$_0$ : $\mathbb{R}$) : Prop :=
  LimitRtoR2 (fun t => (
    (f t).1 - (f t$_0$).1 - (t - t$_0$) * f'₀.1, 
    (f t).2 - (f t$_0$).2 - (t - t$_0$) * f'₀.2
  )) t$_0$ (0, 0)
\end{lstlisting}
...
\begin{lstlisting}[language=Caml]
def HasDerivAt_R_to_C_eps (f : $\mathbb{R} \to \mathbb{C}$) (f'₀ : $\mathbb{C}$) (t$_0$ : $\mathbb{R}$) : Prop := 
  $\forall\ \varepsilon > 0,\ \exists\ \delta > 0,\ \forall$ t : $\mathbb{R}$, 0 < |t - t$_0$| $\wedge$ |t - t$_0$| < $\delta \to$ 
    Complex.abs ((f t - f t$_0$) / (t - t$_0$) - f'₀) < $\varepsilon$
\end{lstlisting}
...
noncomputable def del_eps (ux₀ uy₀ vx₀ vy₀ : $\mathbb{R}$) : $\mathbb{C}$ := 
  ((ux₀ + vy₀) / 2 : $\mathbb{R}$) + I * ((vx₀ - uy₀) / 2 : $\mathbb{R}$)
\end{lstlisting}
