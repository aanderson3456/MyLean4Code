  ...
  | ind a IHa =>
    ...
    | inl hlt =>
      ...
      · rw [Nat.add_comm (a + 1)]
        ...
        · rw [Nat.add_mod_right] -- equivalent to add_mod_left
    ...
    | inr hnlt =>
      ...
      | inl hlt' =>
        rw [if_pos hlt']
        rw [Nat.mod_eq_of_lt]
        · rw [Nat.sub_sub, Nat.add_comm (moment X), Nat.add_sub_cancel] -- this is sub_sub_eq_add_sub equivalent
          -- Wait, in Lean 3: `rw sub_sub_eq_add_sub hnlt, rw add_comm`. This could be tricky in Lean 4 without omega.
          sorry
        · sorry
      | inr hnlt' =>
        sorry
