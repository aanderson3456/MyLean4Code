  ...
  | cons x X' ih =>
    ...
    | zero =>
      ...
      | succ j' =>
        ...
        subst hx
        have H' : num_LOs X' 0 = num_LOs X' j' := H
    ...
    | succ i' =>
      ...
      | zero =>
        ...
        subst hx
        have H' : num_LOs X' i' = num_LOs X' 0 := H
  ...
  | cons x X' ih =>
    ...
    | zero =>
      ...
      | succ j' =>
        ...
        subst hx
        have H' : num_RIs X' 0 = num_RIs X' j' := H
    ...
    | succ i' =>
      ...
      | zero =>
        ...
        subst hx
        have H' : num_RIs X' i' = num_RIs X' 0 := H
