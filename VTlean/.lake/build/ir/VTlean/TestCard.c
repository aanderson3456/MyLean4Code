...
// Module: VTlean.TestCard
// Imports: public import Init public import VTlean.B public import VTlean.VTCode
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_VTlean_VTlean_TestCard(uint8_t builtin) {
lean_object * res;
